...
export default function ColourPop() {
  ...
  const colourpopProducts = displayProducts.filter(item => item.props.children[1].props.children === "Colourpop");

  return (
    <div>
      <img className="portada" src="images/marca2.png" alt="" />
