...
export default function Theordinay() {
  ...
  const theOrdinaryProducts = displayProducts.filter(item => item.props.children[1].props.children === "The Ordinary");

  return (
    <div>
      <img className="portada" src="images/marca1.png" alt="" />
