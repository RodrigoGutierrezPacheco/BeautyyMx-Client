...
export default function Cerave() {
  ...
  const theOrdinaryProducts = displayProducts.filter(item => item.props.children[1].props.children === "CeraVe");

  return (
    <div>
      <img className="portada" src="images/marca4.png" alt="" />
