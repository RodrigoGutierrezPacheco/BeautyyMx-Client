...
export default function Anastacia() {
  ...
  const theOrdinaryProducts = displayProducts.filter(item => item.props.children[1].props.children === "Anastasia Beverly Hills");

  return (
    <div>
      <img className="portada" src="images/marca5.png" alt="" />
